...
interface RectangleShapeData
    ...
    readonly _source: Omit<
        SourceFromSchema<RectangleShapeDataSchema>,
        "type"
    > & { type: "rectangle" };
    type: "rectangle";
}
...
interface CircleShapeData
    extends BaseShapeData<CircleShapeDataSchema>,
        ModelPropsFromSchema<CircleShapeDataSchema> {
    readonly _source: Omit<SourceFromSchema<CircleShapeDataSchema>, "type"> & {
        type: "circle";
    };
    type: "circle";
}
...
interface EllipseShapeData
    ...
    readonly _source: Omit<SourceFromSchema<EllipseShapeDataSchema>, "type"> & {
        type: "ellipse";
    };
    type: "ellipse";
}
...
interface PolygonShapeData
    ...
    readonly _source: Omit<SourceFromSchema<PolygonShapeDataSchema>, "type"> & {
        type: "polygon";
    };
    type: "polygon";
}
