...
declare global {
    ...
    > {
        ...
        Combat: {
            ...
            initiative: {
                formula:
                    | ((combatant: TCombat["turns"][number]) => string)
                    | null;
                decimals: number;
            };
        };
        ...
        Canvas: {
            ...
            layers: {
                ...
                templates: {
                    ...
                    layerClass: ConstructorOf<
                        NonNullable<
                            TMeasuredTemplateDocument["object"]
                        >["layer"]
                    >;
                };
                notes: {
            ...
            lightAnimations: {
                flame: {
                    ...
                    animation: PointLightSource<
                        | TAmbientLightDocument["object"]
                        | TTokenDocument["object"]
                    >["animateTorch"];
        ...
        Dice: {
            ...
            termTypes: Record<
                string,
                ConstructorOf<terms.RollTerm> & {
                    fromData(data: object): terms.RollTerm;
                }
            >;
            terms: {
                c: typeof terms.Coin;
