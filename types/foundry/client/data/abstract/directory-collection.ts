...
export function DirectoryCollectionMixin(
    BaseCollection: ConstructorOf<Collection<object>>,
) {
    /**
...
declare global {
    namespace globalThis {
        type DirectionCollection = InstanceType<
            ReturnType<typeof DirectoryCollectionMixin>
        >;
    }
}
