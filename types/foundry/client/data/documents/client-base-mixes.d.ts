...
> extends foundry.documents.BaseAmbientLight<TParent> {
    ...
    get sheet():
        | DocumentSheet<this>
        | DocumentSheetV2<DocumentSheetConfiguration<this>>;
...
export class ClientBaseItem<
    TParent extends
        ClientBaseActor<CanvasBaseToken<ClientBaseScene | null> | null> | null,
...
declare class ClientBaseRegion<
    TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseRegion<TParent> {
    protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseRegion<
    TParent extends ClientBaseScene | null,
> extends ClientBaseRegion<TParent> {
    /** A reference to the PlaceableObject instance which represents this Embedded Document. */
    _object: PlaceableObject<this> | null;
...
export class ClientBaseRegionBehavior<
    TParent extends ClientBaseRegion<ClientBaseScene | null> | null,
> extends foundry.documents.BaseRegionBehavior<TParent> {
    protected _sheet: DocumentSheet<this> | null;
