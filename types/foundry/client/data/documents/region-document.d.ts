...
declare global {
    ...
    interface RegionDocument<TParent extends Scene | null = Scene | null>
        extends CanvasBaseRegion<TParent> {
        _object: Region<this>;

        readonly behaviors: foundry.abstract.EmbeddedCollection<
            RegionBehavior<this>
        >;
    }

    interface BaseRegionEvent<
    ...
    interface BehaviorStatusRegionEvent<
        TDocument extends RegionDocument = RegionDocument,
        TUser extends User = User,
    ...
    interface RegionBoundaryRegionEvent<
        TDocument extends RegionDocument = RegionDocument,
        TUser extends User = User,
    > extends BaseRegionEvent<TDocument, TUser> {
        name: "regionBoundary";
