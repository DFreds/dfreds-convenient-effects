import type {
    NoteSource,
    TokenSource,
} from "../../../common/documents/module.d.ts";
...
declare global {
    ...
    interface Scene {
        ...
        readonly regions: foundry.abstract.EmbeddedCollection<
            RegionDocument<this>
        >;
        ...
        >;
        readonly tokens: foundry.abstract.EmbeddedCollection<
            TokenDocument<this>
        >;
    ...
    type SceneTokenOperation<TParent extends Scene> =
