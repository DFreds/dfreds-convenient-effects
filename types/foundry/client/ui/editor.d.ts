...
declare global {
    ...
    class TextEditor {
         ...
         */
        protected static _createLegacyContentLink(
            type: string,
            target: string,
            name: string,
            data: object,
