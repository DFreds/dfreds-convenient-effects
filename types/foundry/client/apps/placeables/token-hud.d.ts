...
declare global {
     ...
     */
    class TokenHUD<
        TObject extends Token | undefined = Token | undefined,
    > extends BasePlaceableHUD<TObject> {
        ...
        ): TokenHUDData<NonNullable<TObject>>;
        ...
        protected override _onClickControl(
            event: MouseEvent,
        ): void | Promise<void>;

        protected override _updateAttribute(
            name: string,
            input: string,
        ): Promise<void>;
    }
    ...
    type TokenHUDData<TObject extends Token = Token> =
        BasePlaceableHUDData<TObject> & {
