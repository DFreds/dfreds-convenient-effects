...
declare global {
    ...
    class Tile<
        TDocument extends
            TileDocument<Scene | null> = TileDocument<Scene | null>,
    > extends PlaceableObject<TDocument> {
        ...
        protected override _overlapsSelection(
        ...
        protected override _applyRenderFlags(
        ...
        static createPreview(
            data: DeepPartial<foundry.documents.TileSource>,
        ): Tile;
    }
