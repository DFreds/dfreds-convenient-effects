...
declare abstract class RegionShape<
    TData extends foundry.data.BaseShapeData = foundry.data.BaseShapeData,
> {
    /**
     ...
     * @param   data    The shape data.
     */
    static create<TData extends foundry.data.CircleShapeData>(
        data: TData,
    ): RegionCircle;
    static create<TData extends foundry.data.EllipseShapeData>(
        data: TData,
    ): RegionEllipse;
    static create<TData extends foundry.data.PolygonShapeData>(
        data: TData,
    ): RegionPolygon;
    static create<TData extends foundry.data.RectangleShapeData>(
        data: TData,
    ): RegionRectangle;
    static create<TData extends foundry.data.BaseShapeData>(
        data: TData,
    ): RegionShape<TData>;
...
declare class RegionCircle extends RegionShape<foundry.data.CircleShapeData> {
    protected override _createClipperPolyTree(): (
        | ClipperLib.PolyTree
        | ClipperLib.IntPoint
    )[];
}
