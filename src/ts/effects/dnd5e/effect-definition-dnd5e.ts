...
class EffectDefinitionDnd5e extends EffectDefinition {
    ...
    get #classFeatures(): ItemEffects {
        return {
            itemData: {
                name: game.i18n.localize("ConvenientEffects.Dnd.Folders.ClassFeatures")
            },
            effects: [
    ...
    get #paralyzed(): PreCreate<ActiveEffectSource> {
        const subEffectIds = [this.#incapacitated].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
    ...
    get #acidArrow(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.AcidArrow.description"),
    ...
    get #alterSelf(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.AlterSelf.description"),
    ...
    get #antilifeShell(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.AntilifeShell.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.AntilifeShell.description"),
    ...
    get #arcaneHand(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.ArcaneHand.description"),
    ...
    get #bane(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Bane.description"),
    ...
    get #barkskin(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Barkskin.description"),
    ...
    get #beaconOfHope(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.BeaconofHope.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM,
                    value: "1"
                }, { key: `flags.midi-qol.advantage.deathSave`, mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "1" }]
            }
        });
    }
    ...
    get #blackTentacles(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BlackTentacles.name"),
    ...
    get #bless(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Bless.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "+1d4"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "bloom" }]
            }
        });
    }

    get #blindnessDeafness(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#blindnessDeafnessBlindness, this.#blindnessDeafnessDeafness].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BlindnessDeafness.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.BlindnessDeafness.description"),
    ...
    get #blindnessDeafnessBlindness(): PreCreate<ActiveEffectSource> {
        const subEffectIds = [Flags.getCeEffectId(this.#blinded)].filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.Blindness.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.Blindness.description"),
                img: "icons/magic/perception/eye-ringed-glow-angry-red.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE }
            }, subEffectIds
        });
    ...
    get #blindnessDeafnessDeafness(): PreCreate<ActiveEffectSource> {
        const subEffectIds = [Flags.getCeEffectId(this.#deafened)].filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.Deafness.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.Deafness.description"),
                img: "icons/magic/perception/eye-ringed-glow-angry-red.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE }
            }, subEffectIds
        });
    ...
    get #blur(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Blur.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM,
                    value: "1"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "blur" }]
            }
        });
    }
    ...
    get #command(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Command.description"),
    ...
    get #comprehendLanguages(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ComprehendLanguages.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ComprehendLanguages.description"),
                img: "icons/magic/symbols/runes-triangle-orange-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{ key: "system.traits.languages.all", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "1" }]
            }
        });
    }

    get #contagion(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#contagionBlindingSickness, this.#contagionFilthFever, this.#contagionFleshRot, this.#contagionMindfire, this.#contagionSeizure, this.#contagionSlimyDoom].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.Contagion.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.Contagion.description"),
    ...
    get #contagionBlindingSickness(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BlindingSickness.name"),
    ...
    get #contagionFilthFever(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FilthFever.description"),
                img: "icons/magic/unholy/strike-beam-blood-large-red-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_WEEK },
                changes: [{
    ...
    get #contagionFleshRot(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FleshRot.description"),
                img: "icons/magic/unholy/strike-beam-blood-large-red-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_WEEK },
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM,
                    value: "1"
                }, { key: "system.traits.dv.all", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "1" }]
            }
        });
    }
    ...
    get #contagionMindfire(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Mindfire.description"),
                img: "icons/magic/unholy/strike-beam-blood-large-red-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_WEEK },
                changes: [{
    ...
    get #contagionSeizure(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Seizure.description"),
                img: "icons/magic/unholy/strike-beam-blood-large-red-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_WEEK },
                changes: [{
                    key: `flags.midi-qol.disadvantage.ability.save.dex`,
    ...
    get #contagionSlimyDoom(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.SlimyDoom.description"),
                img: "icons/magic/unholy/strike-beam-blood-large-red-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_WEEK },
                changes: [{
    ...
    get #darkvision(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Darkvision.description"),
    ...
    get #disguiseSelf(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.DisguiseSelf.description"),
    ...
    get #divineWord(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.DivineWord.description"),
    ...
    get #enhanceAbility(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#enhanceAbilityBearsEndurance, this.#enhanceAbilityBullsStrength, this.#enhanceAbilityCatsGrace, this.#enhanceAbilityEaglesSplendor, this.#enhanceAbilityFoxsCunning, this.#enhanceAbilityOwlsWisdom].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.EnhanceAbility.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.EnhanceAbility.description"),
    ...
    get #enhanceAbilityBearsEndurance(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BearsEndurance.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.BearsEndurance.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
    ...
    get #enhanceAbilityBullsStrength(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BullsStrength.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.BullsStrength.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
    ...
    get #enhanceAbilityCatsGrace(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.CatsGrace.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
    ...
    get #enhanceAbilityEaglesSplendor(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.EaglesSplendor.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.EaglesSplendor.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
    ...
    get #enhanceAbilityFoxsCunning() {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FoxsCunning.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
    ...
    get #enhanceAbilityOwlsWisdom() {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.OwlsWisdom.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
    ...
    get #enlargeReduce(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#enlargeReduceEnlarge, this.#enlargeReduceReduce].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.EnlargeReduce.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.EnlargeReduce.description"),
    ...
    get #enlargeReduceEnlarge(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Enlarge.description"),
                img: "icons/magic/control/energy-stream-link-large-blue.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{
                    key: "system.bonuses.weapon.damage",
    ...
    get #enlargeReduceReduce(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Reduce.description"),
                img: "icons/magic/control/energy-stream-link-large-blue.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{
                    key: "system.bonuses.weapon.damage",
    ...
    get #faerieFire(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FaerieFire.description"),
                ...
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "glow" }]
            }
        });
    }
    ...
    get #falseLife(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FalseLife.description"),
    ...
    get #featherFall(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FeatherFall.description"),
    ...
    get #feeblemind(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Feeblemind.description"),
    ...
    get #fireShield(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#fireShieldColdResistance, this.#fireShieldFireResistance].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.FireShield.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.FireShield.description"),
    ...
    get #fireShieldColdResistance(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.FireShieldColdResistance.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.FireShieldColdResistance.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-pentagon-red.webp",
                ...
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "fire" }]
            }
        });
    }
    ...
    get #fireShieldFireResistance(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.FireShieldFireResistance.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.FireShieldFireResistance.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.OVERRIDE,
                    value: "{\"type\": \"torch\", \"speed\": 3, \"intensity\": 1}"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "Fire v2 (coldfire)" }]
            }
        });
    }
    ...
    get #findThePath(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.FindthePath.description"),
    ...
    get #fly(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Fly.description"),
    ...
    get #foresight(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Foresight.description"),
    ...
    get #freedomOfMovement(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.FreedomofMovement.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.FreedomofMovement.description"),
    ...
    get #globeOfInvulnerability(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.GlobeofInvulnerability.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.GlobeofInvulnerability.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-pentagon-blue.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{ key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "warp-field" }]
            }
        });
    }

    get #greaterInvisibility(): PreCreate<ActiveEffectSource> {
        const subEffectIds = [this.#invisible].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.GreaterInvisibility.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.GreaterInvisibility.description"),
    ...
    get #guidance(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Guidance.description"),
                img: "icons/magic/control/buff-flight-wings-blue.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{
    ...
    get #guidingBolt(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.GuidingBolt.description"),
    ...
    get #haste(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Haste.description"),
                img: "icons/magic/control/buff-flight-wings-runes-purple.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{
    ...
    get #heroesFeast(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.HeroesFeast.description"),
    ...
    get #heroism(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Heroism.description"),
    ...
    get #hideousLaughter(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.HideousLaughter.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.HideousLaughter.description"),
                img: "icons/magic/fire/explosion-fireball-medium-purple-pink.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [...(this.#incapacitated.changes ?? []), ...(this.#prone.changes ?? [])]
            }
        });
    }

    get #holdMonster(): PreCreate<ActiveEffectSource> {
        const subEffectIds = [this.#paralyzed].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.HoldMonster.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.HoldMonster.description"),
    ...
    get #holdPerson(): PreCreate<ActiveEffectSource> {
        ...
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.HoldPerson.description"),
    ...
    get #holyAura(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.HolyAura.description"),
    ...
    get #huntersMark(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.HuntersMark.description"),
                img: "icons/magic/perception/eye-ringed-glow-angry-small-red.webp"
            }
        });
    }
    ...
    get #invisibility(): PreCreate<ActiveEffectSource> {
        ...
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Invisibility.description"),
    ...
    get #irresistibleDance(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.IrresistibleDance.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.IrresistibleDance.description"),
                img: "icons/magic/control/energy-stream-link-large-blue.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{
                    key: "system.attributes.movement.all",
    ...
    get #light(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Light.description"),
    ...
    get #longstrider(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Longstrider.description"),
    ...
    get #mageArmor(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.MageArmor.description"),
    ...
    get #mindBlank(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.MindBlank.description"),
                img: "icons/magic/air/air-burst-spiral-large-blue.webp",
                duration: { seconds: SECONDS.IN_ONE_DAY },
                changes: [{ key: "system.traits.di.value", mode: CONST.ACTIVE_EFFECT_MODES.ADD, value: "psychic" }]
            }
        });
    }
    ...
    get #mirrorImage(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.MirrorImage.description"),
                img: "icons/magic/control/debuff-energy-hold-levitate-pink.webp",
                duration: { seconds: SECONDS.IN_ONE_MINUTE },
                changes: [{ key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "images" }]
            }
        });
    }
    ...
    get #passWithoutTrace(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.PasswithoutTrace.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.PasswithoutTrace.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "+10"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "fog" }]
            }
        });
    }

    get #protectionFromEnergy(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#protectionFromEnergyAcid, this.#protectionFromEnergyCold, this.#protectionFromEnergyFire, this.#protectionFromEnergyLightning, this.#protectionFromEnergyThunder].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromEnergy.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromEnergy.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-diamond-teal.webp"
            }, nestedEffectIds
        });
    }
    ...
    get #protectionFromEnergyAcid(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromAcid.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromAcid.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "acid"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "clover" }]
            }
        });
    }
    ...
    get #protectionFromEnergyCold(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromCold.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromCold.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "cold"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "pure-ice-aura" }]
            }
        });
    }
    ...
    get #protectionFromEnergyFire(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromFire.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromFire.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "fire"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "pure-fire-aura" }]
            }
        });
    }
    ...
    get #protectionFromEnergyLightning(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromLightning.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromLightning.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "lightning"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "electric" }]
            }
        });
    }
    ...
    get #protectionFromEnergyThunder(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromThunder.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromThunder.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "thunder"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "shockwave" }]
            }
        });
    }
    ...
    get #protectionFromPoison(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromPoison.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromPoison.description"),
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "poison"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "bevel" }]
            }
        });
    }
    ...
    get #protectionFromEvilAndGood(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromEvilandGood.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ProtectionfromEvilandGood.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-diamond-blue-yellow.webp",
                duration: { seconds: SECONDS.IN_TEN_MINUTES }
            }
        });
    ...
    get #rayOfFrost(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.RayofFrost.description"),
    ...
    get #regenerate(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Regenerate.description"),
    ...
    get #resilientSphere(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ResilientSphere.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ResilientSphere.description"),
                ...
                changes: [{
                    ...
                    value: "*0.5",
                    priority: 25
                }, { key: "system.traits.di.all", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "1" }]
            }
        });
    }
    ...
    get #resistance(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Resistance.description"),
    ...
    get #shield(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Shield.description"),
                ...
                changes: [{
                    ...
                    value: "+5",
                    priority: 5
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "water-field" }]
            }
        });
    }
    ...
    get #shieldOfFaith(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ShieldofFaith.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ShieldofFaith.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-diamond-blue-yellow.webp",
                duration: { seconds: SECONDS.IN_TEN_MINUTES },
                changes: [{
                    key: "system.attributes.ac.bonus",
    ...
    get #slow(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Slow.description"),
    ...
    get #speakWithAnimals(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.SpeakwithAnimals.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.SpeakwithAnimals.description"),
    ...
    get #speakWithDead(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.SpeakwithDead.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.SpeakwithDead.description"),
    ...
    get #speakWithPlants(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.SpeakwithPlants.name"),
    ...
    get #spiderClimb(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.SpiderClimb.description"),
    ...
    get #spiritGuardians(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.SpiritGuardians.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.SpiritGuardians.description"),
    ...
    get #spiritualWeapon(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.SpiritualWeapon.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.SpiritualWeapon.description"),
    ...
    get #stoneskin(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Stoneskin.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-diamond-orange.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
                    key: "system.traits.dr.value",
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "physical"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "oldfilm" }]
            }
        });
    }
    ...
    get #suggestion(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Suggestion.description"),
    ...
    get #telekinesis(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.Telekinesis.description"),
    ...
    get #trueStrike(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.TrueStrike.description"),
    ...
    get #viciousMockery(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ViciousMockery.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ViciousMockery.description"),
    ...
    get #wardingBond(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.WardingBond.description"),
                img: "icons/magic/defensive/shield-barrier-flaming-diamond-blue-yellow.webp",
                duration: { seconds: SECONDS.IN_ONE_HOUR },
                changes: [{
                    key: "system.attributes.ac.bonus",
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM,
                    value: "physical"
                }, { key: "system.traits.dr.all", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "magical" }]
            }
        });
    }
    ...
    get #waterBreathing(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.WaterBreathing.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.WaterBreathing.description"),
    ...
    get #waterWalk(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                description: game.i18n.localize("ConvenientEffects.Dnd.WaterWalk.description"),
    ...
    get #bardicInspiration(): PreCreate<ActiveEffectSource> {
        const nestedEffectIds = [this.#bardicInspirationD6, this.#bardicInspirationD8, this.#bardicInspirationD10, this.#bardicInspirationD12].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BardicInspiration.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.BardicInspiration.description"),
    ...
    get #bardicInspirationD6(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BardicInspirationd6.name"),
    ...
    get #bardicInspirationD8(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BardicInspirationd8.name"),
    ...
    get #bardicInspirationD10(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BardicInspirationd10.name"),
    ...
    get #bardicInspirationD12(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.BardicInspirationd12.name"),
    ...
    get #channelDivinitySacredWeapon(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ChannelDivinitySacredWeapon.name"),
    ...
    get #channelDivinityTurnTheUnholy(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ChannelDivinityTurntheUnholy.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ChannelDivinityTurntheUnholy.description"),
    ...
    get #channelDivinityTurnUndead(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.ChannelDivinityTurnUndead.name"),
                description: game.i18n.localize("ConvenientEffects.Dnd.ChannelDivinityTurnUndead.description"),
        ...
        return createConvenientEffect({
            effect: {
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "radiant"
                }, { key: "system.traits.dr.value", mode: CONST.ACTIVE_EFFECT_MODES.ADD, value: "thunder" }]
            }
        });
    }
    ...
    get #kiPatientDefense(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.KiPatientDefense.name"),
    ...
    get #rage(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "outline" }]
            }, isDynamic: true
        });
    }

    get #recklessAttack(): PreCreate<ActiveEffectSource> {
        const subEffectIds = [this.#recklessAttackAdvantage].map((effect) => Flags.getCeEffectId(effect)).filter(notEmpty);
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.RecklessAttack.name"),
    ...
    get #recklessAttackAdvantage(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                name: game.i18n.localize("ConvenientEffects.Dnd.RecklessAttackadvantageonattacks.name"),
    ...
    get #bonusAction(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                flags: { dae: { specialDuration: ["turnStart", "shortRest", "longRest"] } }
            }
        });
    }
        ...
        return createConvenientEffect({
            effect: {
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.ADD,
                    value: "+5"
                }, { key: "system.abilities.dex.bonuses.save", mode: CONST.ACTIVE_EFFECT_MODES.ADD, value: "+5" }]
            }
        });
    }
        ...
        return createConvenientEffect({
            effect: {
                ...
                changes: [{
                    ...
                    mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM,
                    value: "1"
                }, { key: "macro.tokenMagic", mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: "Evade Stance" }]
            }
        });
    }
    ...
    get #inspiration(): PreCreate<ActiveEffectSource> {
        return createConvenientEffect({
            effect: {
                ...
                flags: { dae: { specialDuration: ["1Action", "isSave", "isCheck", "isSkill"] } },
                changes: [{
