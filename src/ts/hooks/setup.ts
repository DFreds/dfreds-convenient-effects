    ...
    listen(): void {
        Hooks.once("setup", () => {
            libWrapper.register(
                ...
                function (this: ActiveEffect<any>, wrapped: (...args: any) => boolean, ...args: any) {
            ...
            libWrapper.register(
                ...
                async function (this: Item<any>, wrapped: (...args: any) => void, ...args: any) {
                    ...
                    convenientItem.effects = convenientItem.effects?.filter(notEmpty).map((effect) => {
