...
abstract class BaseConvenientEffectsV2 extends HandlebarsApplicationMixin(
    ...
    static async #onCollapseFolders(): Promise<void> {
        const thisClass = this as unknown as BaseConvenientEffectsV2;
    ...
    abstract _canDragDrop(_selector: string): boolean;
...
export type { ConvenientEffectsOptions };
